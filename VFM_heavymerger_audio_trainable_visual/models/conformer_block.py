# Author lucidrain @ https://github.com/lucidrains/conformer/blob/master/conformer/conformer.py
...
class Attention(nn.Module):
    ...
    def forward(self, x, context = None, mask = None, context_mask = None):
        ...
        dist = torch.clamp(dist, min=-max_pos_emb, max=max_pos_emb) + max_pos_emb
